...
values
  ...
  ('dashboard', 'quick_actions', 'Start new POS transaction', null, null, null, '/pos', null, 1),
  ('dashboard', 'quick_actions', 'Restock low items', null, null, null, '/inventory', null, 2),
  ('dashboard', 'quick_actions', 'Create discount campaign', null, null, null, '/discounts', null, 3),
  ('dashboard', 'quick_actions', 'Add new customer profile', null, null, null, '/customers', null, 4),

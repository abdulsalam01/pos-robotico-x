...
export default function PosClient({
  ...
  const handleComplete = () => {
    setActionNotice("Transaction completed. Receipt is ready to print.");
  };

  const handleDraft = () => {
    setActionNotice("Draft saved. Resume from the drafts list anytime.");
  };
    ...
    <div className="grid gap-6 xl:grid-cols-[1.6fr,1fr]">
      <div className="space-y-6">
        <Card>
          <SectionHeader
            ...
            action={<Button onClick={() => setScannerOpen(true)}>Open scanner</Button>}
          />
      ...
      <Card className="space-y-6">
        ...
        <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 text-xs text-slate-500 dark:border-white/10 dark:bg-white/5 dark:text-slate-300">
          {totalItems} items in cart. Pricing will follow the selected variant size.
        </div>
        {actionNotice ? (
        ...
        <div className="flex flex-col gap-3">
          <Button onClick={handleComplete}>Complete transaction</Button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4">
          <div className="w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-soft dark:border-white/10 dark:bg-slate-900">
            ...
            <div className="mt-4 flex gap-3">
              <Button onClick={() => setScannerOpen(false)}>Done scanning</Button>
